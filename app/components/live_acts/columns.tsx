...
export const columns: ColumnDef<LiveAct>[] = [
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title={columnTitles.contactEmail} />
    ),
    cell: ({ row }) => (
      <EmailCell email={row.original.contactEmail} />
    ),
  },
  {
    accessorKey: "contactPhone",
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title={columnTitles.contactPhone} />
    ),
  },
  {
    id: "status",
