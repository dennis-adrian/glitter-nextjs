...
function Drawer({
	...
	return (
		<>
			{/*
			 * Vaul uses Radix Dialog internally but never passes `modal` to it,
			 * so Radix always runs in modal mode and sets `pointer-events: none`
			 * on `<body>`. Vaul tries to undo this via requestAnimationFrame,
