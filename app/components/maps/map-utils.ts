...
export function getStandFillColor(
  ...
  switch (status) {
    ...
    default:
      return canBeReserved ? "rgba(254, 243, 199, 0.01)" : "rgba(39, 39, 42, 0.4)";
  }
}
...
export function getStandHoverFillColor(
  ...
  switch (status) {
    ...
    default:
      return canBeReserved ? "rgba(254, 243, 199, 0.6)" : "rgba(39, 39, 42, 0.5)";
  }
}
...
export function getStandStrokeColor(
  ...
  switch (status) {
    ...
    default:
      return canBeReserved ? "rgba(217, 119, 6, 0.4)" : "rgba(113, 113, 122, 0.6)";
  }
}
