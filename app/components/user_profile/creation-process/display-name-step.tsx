...
export default function DisplayNameStep(props: DisplayNameStepProps) {
  ...
  let descriptionSnippet =
    "Agrega tu nombre de artista o con el que te reconocen en redes sociales y una bio compartiendo un poco sobre ti y tus intereses.";
  if (props.profile.category === "entrepreneurship") {
    ...
    descriptionSnippet =
      "Agrega el nombre de tu emprendimiento con el que te reconocen en redes sociales y una descripción de lo que creas y ofrecerás en los eventos.";
  }
  ...
  if (props.profile.category === "gastronomy") {
    ...
    descriptionSnippet =
      "Agrega el nombre de tu negocio gastronómico y una descripción de lo que ofrecerás en los eventos.";
  }

  return (
    <>
      <StepDescription title={title} description={descriptionSnippet} />
      <DisplayNameForm
