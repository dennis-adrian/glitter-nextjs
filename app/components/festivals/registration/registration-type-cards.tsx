...
function TypeCard({
  ...
  return (
    <div
      className="w-80 rounded-md flex border items-center justify-between shadow-md px-4 py-6 hover:bg-primary-200/30 hover:text-primary-700 hover:border-primary-700 cursor-pointer"
      onClick={onClick}
    >
