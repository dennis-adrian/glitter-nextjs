    ...
    <div className="container p-4 md:p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        ...
        <CategoryCard title="Crochet">
          ...
          <p>
            El arte del crochet involucra la técnica de tejido con la ayuda de
            un ganchillo, por medio del cual pueden se crear piezas únicas y muy
        ...
        <CategoryCard title="Bisutería / Bijouteria">
          ...
          <p>
            En nuestros festivales se ha abierto la categoría
            Bisutería/Bijouteria para aquellos emprendimientos que deseen
            mostrar y vender estos accesorios.
          </p>
        </CategoryCard>
        ...
        <CategoryCard title="Arte en papel / Papercraft">
          <p>
            ¿Tenes habilidad para las manualidades en distintos tipos de papel?
            El arte en este material que para muchos quizás sea algo muy común,
            puede hacer volar nuestra imaginación; desde origami, escultura en
            papel, collages, recortes, modelos 3D hechos a mano, hasta rosas
            eternas ¡todo en esta categoría!
          </p>
        </CategoryCard>
        ...
        <CategoryCard title="Arte en arcilla">
          ...
          <p>
            ...
            plasticidad y su acabado rígido. Además, una vez finalizada la
            pieza, puede añadirse color haciendo más viva la obra.
          </p>
          <p>
            Si eres un artista que realiza sus obras en arcilla, ¡el festival
            creó esta categoría para vos!
          </p>
        </CategoryCard>
        ...
        <CategoryCard title="Diseño y confección">
          ...
          <p>
            Si eres diseñador/a de moda y cuentas con tu propia línea de ropa,
            ya sea poleras, jeans, vestidos, faldas, zapatos, carteras, etc.,
        ...
        <CategoryCard title="Encuadernación">
          ...
          <p>
            ...
            sujetos por ambos lados de una tapa resistente, con el fin de
            mantener en orden y a salvo las páginas. Y además, ¡puedes dotarlas
            de diseños únicos!
          </p>
          <p>
            Además, si te dedicas a la personalización de diarios o álbumes a
            partir de recortes varios, manualidades o cualquier tipo de
            elemento, ¡también te tomamos en cuenta!
          </p>
          <p>¿La encuadernación es lo tuyo? ¡Estás en el lugar correcto!</p>
        </CategoryCard>
        <CategoryCard title="Bordado">
          <p>
            El fino arte que requiere dedicación y paciencia. Consiste en
            aplicar mediante hilos de diversos colores y aguja una decoración en
            una tela lisa, también denominada fondo.
          </p>
          <p>
        ...
        <CategoryCard title="Pintura">
          <p>
            Óleo, acuarela, gouache, témpera, acrílico, pastel o tinta, la
            pintura es un arte tan amplio y que requiere de tantos conocimientos
            que su práctica se conserva a pesar de su longevidad.
          </p>
          <p>
        ...
        <CategoryCard title="Libros y cómics">
          ...
          <p>
            Si eres un autor boliviano independiente, o cuentas con colecciones
            de libros, cómics y/o mangas variados, tanto nacionales como
        ...
        <CategoryCard title="Sublimación colaborativa">
          <p>
            ...
            poleras, llaveros, tazas, gorras, etc., y gustas ser parte de
            Glitter, puedes hacerlo únicamente si los diseños de los productos
            que ofreces son colaborativos o pagados a un ilustrador.{" "}
          </p>
          <p>
