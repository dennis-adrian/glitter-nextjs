		...
		return (
			<div className="container p-4 md:p-6">
				...
				<div className="flex flex-col gap-3 mt-6">
					...
					<p>
						El Sticker-Print es una actividad en la cual incentivaremos al
						público asistente del evento a coleccionar stickers.
					</p>
					<p>
          ...
          />
				...
				<div className="flex flex-col gap-3 mt-6">
					...
					<p>
						...
						ingresar al festival por un valor de 15Bs. En total se imprimirán
						160 Sticker-Prints, lo que equivale a 40 unidades de cada diseño.
					</p>
					<p>
					...
					<p>
						Al ser 4 diseños, en total podremos contar con la participación de
						32 ilustradores distintos.
					</p>
					<p>
				...
				<div className="flex flex-col gap-3 mt-6">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 mx-auto">
						{stickerPrintActivity.details.map((detail) => (
				...
				<div className="flex flex-col gap-3 mt-6">
					...
					<ul className="ml-4 list-disc list-inside">
						...
						<li>
							...
							cantidad mínima de participantes, podrá ser retirado de la
							actividad lo cual se comunicará hasta el lunes 7 de abril.
						</li>
						<li>
