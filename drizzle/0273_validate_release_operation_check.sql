-- Validates the constraint 0271 added NOT VALID. Drizzle runs each migration
...
--
-- A no-op where the constraint is already valid, so it is safe on every
-- environment regardless of when 0271 landed there.
