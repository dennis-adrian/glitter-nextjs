ALTER TABLE "profile_tasks" RENAME TO "scheduled_tasks";--> statement-breakpoint
ALTER TABLE "scheduled_tasks" DROP CONSTRAINT "profile_tasks_profile_id_users_id_fk";
